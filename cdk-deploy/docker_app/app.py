"""
Agentic RAG Chatbot - Production Streamlit UI
Enhanced ReAct-based chatbot with health check endpoint
"""
...
from citation_display import display_citation_expandable_with_id, display_citation_expandable
...
def health_check():
    ...
    try:
        ...
        if Config.KB_ID == "YOUR_KB_ID_HERE":
            health_status["status"] = "unhealthy"
            health_status["error"] = "KB_ID not configured"
...
def main():
    ...
    st.markdown("개선된 ReAct 기반 AI 어시스턴트 - 완전한 Citation 표시 지원")
